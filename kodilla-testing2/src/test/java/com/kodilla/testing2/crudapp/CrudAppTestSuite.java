...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://zbig1000.github.io/";
    private WebDriver driver;
    private Random generator;

    @Before
    public void initTests() {
        driver = WebDriverConfig.gerDriver(WebDriverConfig.CHROME);
        driver.get(BASE_URL);
...
//        driver.close();
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        WebDriver driverTrello = WebDriverConfig.gerDriver(WebDriverConfig.CHROME);
        driverTrello.get(TRELLO_URL);

        driverTrello.findElement(By.id("user")).sendKeys("zbig.lupina@gmail.com");
    ...
    public void shouldCreateTrellocard() throws InterruptedException {
        ...
        cleanCrudeTestTask(taskName);
    }

    private void cleanCrudeTestTask(String taskName) throws InterruptedException {
